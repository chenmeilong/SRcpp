...
void DrawWidget::resizeEvent(QResizeEvent *event)  //绘制窗口改变响应函数
{
    if(height()>pix->height()||width()>pix->width())	//(a)判断改变后的窗体是否大于改变前的窗体
    {
